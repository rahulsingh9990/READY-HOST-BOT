...
YOUR_USERNAME = YOUR_USERNAME or '@R4HULxTRUSTED'
UPDATE_CHANNEL = UPDATE_CHANNEL or 'https://t.me/freekasearch2'
...
async def cmd_start(message: types.Message):
    ...
    welcome_text = f"""
╔═══════════════════════╗
    🌟 <b>WELCOME TO FKS FILE HOST BOT</b> 🌟
╚═══════════════════════╝
